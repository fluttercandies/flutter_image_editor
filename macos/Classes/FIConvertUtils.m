...
- (CGFloat)getValue:(NSUInteger)index {
...
+ (id)createFromDict:(NSDictionary *)dict {
  ...
  CGFloat b = [ins b];
  CGFloat a = [ins a];
  ins.color = [FIColor colorWithRed:r / 255.0 green:g / 255.0 blue:b / 255.0 alpha:a / 255.0];
...
//    [result addObject:[NSValue valueWithCGPoint:point]];
      [result addObject:[FICommonUtils pointToArray:point]];
  }
